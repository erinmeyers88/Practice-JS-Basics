...
function bigFunction(parameter) {
  return function () {
    myFunction();
  }
}

bigFunction(myFunction());
...
/*
  ...
  *Hint: setTimeout calls a function or evaluates an expression after a specified number of milliseconds.
    ...
    The function will count every second up to 5 seconds.
  ...
  Was your answer right or wrong?
    ...
    Wrong, it wrote 6 and the browser showed 5 seconds elapsing.
